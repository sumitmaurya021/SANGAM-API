...
ActiveRecord::Schema[8.1].define(version: 2026_06_26_070000) do
  ...
  create_table "remember_tokens", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.bigint "user_id", null: false
    t.index ["token_hash"], name: "index_remember_tokens_on_token_hash", unique: true
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.boolean "remember_me_pending", default: false, null: false
